    ...
    public ZoomImageView(Context context, AttributeSet attrs) {
        ...
        mGestureDetector = new GestureDetector(context, new GestureDetector.SimpleOnGestureListener() {
            ...
            public boolean onDoubleTap(MotionEvent e) {
                ...
                float x = e.getX();
                float y = e.getY();
//                LogPrint.d("xx", "DoubleTap:" + getScale() + " , " + initScale);
...
//        LogPrint.e("xx", "deltaX = " + deltaX + " , deltaY = " + deltaY);
...
//                Log.e(TAG, "ACTION_UP");
    ...
    public void onGlobalLayout() {
        ...
        int width = getWidth();
        int height = getHeight();
//        LogPrint.d("xx", "屏幕的宽高" + width + "," + height);
        // 拿到图片的宽和高
        int dw = d.getIntrinsicWidth();
        int dh = d.getIntrinsicHeight();
//        LogPrint.d("xx", "图片的宽高" + dw + "," + dh);
        float scale = 1.0f;
        ...
        initScale = scale;
//        LogPrint.d("xx", "缩放" + initScale);

//        LogPrint.d("xx", "初始化平移" + (width - dw) / 2 + "," + (height - dh) / 2);
